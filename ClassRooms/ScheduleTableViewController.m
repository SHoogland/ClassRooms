...
- (void)viewDidLoad {
    ...
    NSLog(@"Viewloaded");
    self.title = @"Class room schedule";
    ...
    self.loadingLabel = [[UILabel alloc] initWithFrame:CGRectMake(0,
                                                                  ...
                                                                  20)];
    self.loadingLabel.text = @"Rooster Ophalen";
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    if (section != 0)
    {
        ...
        NSLog(@"number of rows: %lu", (unsigned long)[activitiesOnThisDay count]);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(indexPath.section != 0)
    {
        ...
        cell.textLabel.text = [rowActivity objectForKey:@"name"];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if (section == 0)
    {
        ...
        UILabel *roomName = [[UILabel alloc] initWithFrame:CGRectMake(0, 150, imageView.bounds.size.width /2 , 30)];
